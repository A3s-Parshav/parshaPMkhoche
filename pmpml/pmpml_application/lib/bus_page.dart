...
//       ..repeat(reverse: true);
//     _zoomAnimation =
//         Tween<double>(begin: 1.0, end: 1.256).animate(CurvedAnimation(
...
//                                                   color: Colors.black)),
//                                           Transform.translate(
//                                             offset: Offset(-32, 20), // tuned to sit just below the '7' without overlap
//                                             child: Text(
//                                               '3',
//                                               style: TextStyle(
//                                                 fontWeight: FontWeight.w800,
...
class _BusPassPageState extends State<BusPassPage>
  ...
  void initState() {
    ...
    _zoomAnimation = Tween<double>(
      begin: 0.8,   // start at 0.8× size (you can set this to e.g., 0.5 if you want even smaller)
